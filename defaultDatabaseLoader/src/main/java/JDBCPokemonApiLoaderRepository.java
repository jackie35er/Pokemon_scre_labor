...
public record JDBCPokemonApiLoaderRepository(Connection connection) implements PokemonApiLoaderRepository {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        JDBCPokemonApiLoaderRepository defaultPokemonInserter = new JDBCPokemonApiLoaderRepository(connection);
